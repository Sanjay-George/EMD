        ...
        <div class="row">
			...
			<h3>Your order has been placed successfully.</h3>
                <div class='col m12 s-card-header'>
                    <div class='col m9'>Order Details Receipt: </div>
                </div> 
...
-->
                        ...
                        <div class="col m12 center" style="padding-top:0px; padding-bottom:30px;">
                            <button name="submit" class='waves-effect waves-light btn light-blue darken-1'><i class='material-icons'>send</i><span>Submit</span></button>
                        </div>
                    </form>
                </div>
            </div>
...
$(document).ready(function(){
    ...
    $('button[name="submit"]').click(function(e){
		...
		alert("Thank you for purchasing from EMD");
